...
| 当前阶段 | C132 中文侧栏工具入口修复 verified/100%；C127 in-progress/85%，Bluesky 已 ready/enabled，固定 smoke 仅等待 matching campaign 授权           |
| 增长现状 | 95 中文 + 95 英文与 190 页静态产物已双轨上线；无 tracker；GitHub/Bluesky ready/enabled；微博 Free 只读且零写额度，API 发布 disabled         |
