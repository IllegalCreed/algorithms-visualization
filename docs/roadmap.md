...
| 测试基线 | 2026-08-10 C142：304 个 Vitest 文件 / 2178 条 L3/L4 用例通过；coverage 93.25/84.89/90.31/93.69%，Desktop 125/125、mobile 9/9（含播放器/轨道回归），双 base 各 190 页构建与静态资源地址门禁通过 |
...
| P1     | 低风险维护修复       | verified | C137-C142 已完成并双轨上线；后续仅观察真实 Safari/触控和 CSP Report-Only                                                   |
