...
> Progress: 68%
> Blocked by: none
> Next action: 展开 T3-C GitHub Release 低风险 write/read/delete smoke 证据与 Issue/collector Case
...
| TC-DOC-AUTO-127-04 | docs | marketing/roadmap/agent 记忆 | C127 一致为 in-progress/68%、T1/T2/T3-A/T3-B 完成且下一步为 T3-C；不把 health ready 写成已启用实发 |
...
| TC-DOC-AUTO-127-08 | docs | plan 状态                    | T0-T3-B 已完成，但 activation、collector、其他 adapter 与真实发布未完成；四文档不得误标 verified   |
...
| T3-C-T5 运行时 Case            | planned | -          | 其余渠道、collector 与真实 smoke 后续展开             |
