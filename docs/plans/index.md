...
| C-20260622-009 | feature             | 头部分享/仓库按钮   | 头部三按钮各司其职：GitHub 开本仓库；微博/X 分享当前页（线上域名+当前 path+文案）；抽 share.ts 纯函数 + useIconLink 响应式 | draft    | 0%     | 无     | 写 implementation 后实现          | home / docs-shell              | IllegalCreed | `20260622-c009-header-share-buttons/` | 2026-06-22 | -             |
...
| C-20260622-009 | 头部分享/仓库按钮 | draft    | 0%     | 无     | 实现   | `20260622-c009-header-share-buttons/` |
...
| C-20260622-009 | feature | 头部分享/仓库按钮（微博/X 分享 + GitHub 仓库） | draft    | 0%     | `20260622-c009-header-share-buttons/` |
