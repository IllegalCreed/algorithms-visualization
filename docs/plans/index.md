...
| C-20260622-010 | feature             | 希尔排序动画        | 用算法播放器框架接入希尔排序（gap 分组插入：步长 ⌊n/2⌋ 减半、逐组插入；复用插入排序移位插桩、泛化为 gap 步长；新增 groupMembers/dimmed 聚焦当前组淡化其余），M3 第三个算法 | draft    | 0%     | 无     | 待 review spec → writing-plans 出 impl/tests | viz-engine / article-sort / M3 | IllegalCreed | `20260622-c010-shell-sort/`           | 2026-06-22 | -             |
...
| C-20260622-010 | 希尔排序动画      | draft    | 0%     | 无     | 待 review spec | `20260622-c010-shell-sort/`           |
...
| C-20260622-010 | feature | 希尔排序动画     | draft    | 0%     | `20260622-c010-shell-sort/`         |
