...
| Case ID              | 标题                                                         | 层级 | 自动化路径                                       |
| -------------------- | ------------------------------------------------------------ | ---- | ------------------------------------------------ |
| TC-HOOK-01-1         | 三分类，图算法含 Dijkstra+Kruskal+Prim+Bellman-Ford（C-050） | L3   | `src/views/Home/Main/hooks.spec.ts`              |
...
| Case ID              | 标题                                                         | 层级 | 自动化路径                                     |
| -------------------- | ------------------------------------------------------------ | ---- | ---------------------------------------------- |
| TC-HOOK-02-1         | 三分类，图算法含 Dijkstra+Kruskal+Prim+Bellman-Ford（C-050） | L3   | `src/views/Docs/Menu/hooks.spec.ts`            |
...
## article-algo（图算法，C-037/038/049/050；Dijkstra 于 C-047、Kruskal 于 C-048 返工进播放器）
