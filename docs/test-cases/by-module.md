...
| Case ID              | 标题                                           | 层级 | 自动化路径                                       |
| -------------------- | ---------------------------------------------- | ---- | ------------------------------------------------ |
| TC-HOOK-01-1         | 三分类，图算法含 Dijkstra+Kruskal（C-038）     | L3   | `src/views/Home/Main/hooks.spec.ts`              |
...
| TC-HOOK-02-4         | 数据结构 15 项，排序 11 项（新增三路快排 C-041） | L3   | `src/views/Docs/Menu/hooks.spec.ts`            |
