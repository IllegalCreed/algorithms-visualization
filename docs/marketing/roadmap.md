...
> Related plans: C-20260710-123、C-20260710-124、C-20260710-129、C-20260711-126、C-20260711-127；C-20260629-034 与 C-20260710-125 已 superseded
...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、十组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销，站点多语言完成十页试点。C127 已完成 15 个渠道的官方能力审计，分发实现尚未开始。
...
| -------- | ------------------------ | ------------------------------------------------------------------------ | ------------------------------------ | ---------------------------------------- |
| 国内中文 | 学生、求职者、中文开发者 | 自动优先微博；B站/公众号条件接入；V2EX/掘金保留人工；GitHub 同步项目动态 | C127 adapter + 对应官方账号授权      | 获取种子用户、收集产品反馈、比较渠道效率 |
| 海外英文 | 英文学习者与开发者       | 自动优先 Bluesky、DEV、Mastodon、GitHub；Reddit 条件接入；HN/PH 人工发布 | C126 + C127；逐渠道完成官方授权/审核 | 验证英文需求、自然搜索与海外渠道         |
...
| C127 | 提示词生成 campaign，以能力 gate 调用官方 adapter | implementing |
...
| B站/公众号       | B：资质满足后自动          | 视频 / 图文             | 完播或阅读、关注、聚合互动与可得留言 |
| Reddit           | B：审核与社区授权后自动    | 社区定制帖              | 社区接受度、保存/评论                |
| V2EX/HN/PH       | C：人工发布后自动监测      | 短帖 / Show HN / 发布页 | 技术反馈、讨论质量、公开互动         |
| 掘金/知乎/小红书 | D：人工渠道                | 长文 / 笔记             | 不纳入 C127 自动化承诺               |
| X                | 付费可选                   | 英文短帖                | 预算批准后再定义                     |
