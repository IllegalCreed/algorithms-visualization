...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C131 的英文全量目录已 verified；C127 T3-A 已完成并达到 62%，当前进入 GitHub CLI typed client 阶段。
...
| C127 | T3-A 已完成；下一步接 live typed client，凭据继续与 Codex 隔离 | in-progress |
