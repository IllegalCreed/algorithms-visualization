...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C131 的英文全量目录已 verified；C127 T3-C GitHub create/read/delete/tag-cleanup smoke 已完成并达到 76%，当前进入其余首批 adapter 阶段。
...
| C127 | T3-C 已完成；GitHub ready/enabled 且真实 smoke 已完整清理，下一步 T3-D 其余首批 adapter | in-progress |
