...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C127 为 90%；微博 API disabled，GitHub/Bluesky 闭环完成，DEV 工程/preflight/setup 完成并 ready/enabled，尚无文章。
...
| C127 | GitHub/Bluesky 闭环、DEV 工程/preflight/setup 完成；下一步正式文章 matching 授权 | in-progress |
