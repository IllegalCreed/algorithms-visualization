...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C131 的英文全量目录已 verified；C127 T3-B 已完成并达到 68%，当前进入 GitHub Release smoke 与 collector contract 阶段。
...
| C127 | T3-B 已完成；GitHub health ready 但 adapter disabled，下一步 T3-C smoke/collector | in-progress |
