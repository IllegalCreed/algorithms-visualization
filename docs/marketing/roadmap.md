...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C127 达到 79%，微博 device OAuth 已完成，个人开发者认证正在官方审核。
...
| C127 | 微博 device OAuth 已完成、个人开发者认证审核中；adapter disabled，之后完成 Free gate/action 冻结 | in-progress |
