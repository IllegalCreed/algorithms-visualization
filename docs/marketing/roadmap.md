...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C127 为 87%；微博 Free 零写额度，Bluesky 已 ready/enabled 且 Owner 授权的固定 smoke 已完成清理。
...
| C127 | 微博 API disabled；Bluesky setup、安全删除与真实 smoke 完成，下一步 DEV adapter | in-progress |
