...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C131 英文全量目录已 verified；C127 已完成 GitHub smoke 与微博 T3-D1-A 无写边界并达到 79%，当前等待微博官方 setup。
...
| C127 | T3-D1-A 已完成；GitHub ready/enabled，微博 adapter disabled，下一步官方 setup 与 action 冻结 | in-progress |
