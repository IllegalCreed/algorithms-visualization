...
3. route head、尾斜杠 canonical、JSON-LD、按 catalog 生成的 sitemap/llms、95 组双向 hreflang 与 crawler 策略已落地；第三方分析已撤销。C131 的英文全量目录已 verified，C127 宣传自动化恢复为当前阶段。
...
| C127 | 通过独立 MCP 调用 API/RPA；凭据与 Codex 隔离 | in-progress |
