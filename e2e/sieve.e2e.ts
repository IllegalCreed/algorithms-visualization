...
test('TC-E2E-SIEVE-01 埃氏筛全模板：正文 + 数字网格 / 拖到末步 10 个素数', async ({ page }) => {
  await page.goto('/docs/sieve-of-eratosthenes');

  // 全模板①：介绍正文 Article（h1 含「筛」）
  await expect(page.locator('.article h1')).toContainText('筛');
